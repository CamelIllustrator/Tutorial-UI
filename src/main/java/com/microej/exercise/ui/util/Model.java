...
public class Model extends SimpleObservable {
	 ...
	 *
	 * Step 12.1: Update the Model to use NLS methods
	 *
	 * 1. Create the file step12.nls.list in the resource folder and add a line to declare the classes to generate. <br>
	 * 2. Build the application to generate the sources: open the Gradle pane and select Tasks > build > clean
	 * then Tasks > build > build. <br>
	 * 3. Update the getCurrentLocale() method to use NLS. <br>
	 * 4. Update the setCurrentLocale() method to use NLS.
	 *
	 */
