...
public class WatchfacePage extends Page {
	...
	public void populateStylesheet(CascadingStylesheet stylesheet) {
		 ...
		 * 2. Use the large font for the heart rate.<br>
		 * 3. Set the icon color of the heart rate to be blue (see ej.microui.display.Colors).<br>
		 * 4. Use the medium font for the seconds of the digital clock.<br>
		 * 5. Make the digital clock to be horizontally center-aligned and vertically bottom-aligned.<br>
		 * 6. Set the text color of the steps and distance to be yellow by giving them a class
		 * and using a ClassSelector (see addClassSelector()).<br>
		 * 7. Set the battery indicator to be black.
		 */
