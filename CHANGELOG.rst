...
- Add instructions & solution for step 11: creation of a new Parameters page
- Add instructions & solution for step 12: internationalization with NLS

Changed
=======

- Update gradle version to 8.6
- Update gradle plugin version to 1.0.0
